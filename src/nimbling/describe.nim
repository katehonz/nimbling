...
proc `$`*(d: Descriptor): string =
  ...
  of TY_CLOSURE: "closure"
  of TY_CACHED_STRING: "cached_string"
  of TY_STRING: "string"
  of TY_REF: "ref(" & $d.inner[] & ")"
  of TY_REFMUT: "refmut(" & $d.inner[] & ")"
  of TY_LONGREF: "longref(" & $d.inner[] & ")"
  of TY_SLICE: "slice(" & $d.inner[] & ")"
  of TY_VECTOR: "vector(" & $d.inner[] & ")"
  of TY_EXTERNREF: "externref"
  of TY_NAMED_EXTERNREF: "named_externref(" & d.nameStr & ")"
  of TY_ENUM: "enum(" & d.nameStr & ", hole=" & $d.enumHole & ")"
  of TY_STRING_ENUM: "string_enum(" & d.nameStr & ")"
  of TY_RUST_STRUCT: "struct(" & d.nameStr & ")"
  of TY_CHAR: "char"
  of TY_OPTIONAL: "option(" & $d.inner[] & ")"
  of TY_RESULT: "result(" & $d.inner[] & ")"
  of TY_UNIT: "unit"
  of TY_CLAMPED: "clamped(" & $d.inner[] & ")"
  of TY_NONNULL: "nonnull(" & $d.inner[] & ")"
  of TY_RAW_POINTER: "raw_pointer"
